    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                <strong>Panel murah hanya di @MasCarli_id
                <i class="fa fa-info-circle"></i> 
                Protected by: 
                <span class="label label-primary">@MasCarli_id</span>
                <span class="label label-success">@MasCarliInfo</span>
            </p>
        </div>
        @else
    ...
    ">
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <span style="background: #e84393; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@MasCarli_id</span>
                <span style="background: #0984e3; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@MasCarliInfo</span>
            </div>
        </div>
...
echo "🛡️ Security by: @MasCarli_id"
