...
class NodeViewController extends Controller
{
    ...
    private function checkNodeAccess($request, Node $node = null)
    {
        ...
        abort(403, '✖️ ᴀᴋsᴇs ᴅɪ ᴛᴏʟᴀᴋ ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴍᴀsᴄᴀʀʟɪ ᴏғғɪᴄɪᴀʟ');
    }
...
@if($user->id !== 1)
    ...
    ">
        ...
        <p style="font-size: 14px; color: #95a5a6;">protect by @MasCarli_id</p>
    </div>
    @php
...
echo "🚫 Pesan error: 'akses ditolak, protect by @MasCarli_id'"
