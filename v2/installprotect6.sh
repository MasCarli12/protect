...
echo "🚀 Memasang proteksi Anti Settings Access..."
...
class IndexController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $user = Auth::user();
        if (!$user || $user->id !== 1) {
            abort(403, '🚫 ᴀᴋsᴇs ᴅɪ ᴛᴏʟᴀᴋ ᴘʀᴏᴛᴇᴄᴛ ʙʏ ᴍᴀsᴄᴀʀʟɪ ᴏғғɪᴄɪᴀʟ.');
        }
...
echo "✅ Proteksi Anti Settings Access berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"
echo "🗂️ Backup file lama: $BACKUP_PATH (jika sebelumnya ada)"
echo "🔒 Hanya Admin ID 1 yang bisa:"
echo "   • Mengakses menu Settings"
echo "   • Mengubah pengaturan panel"
echo "   • Melihat informasi versi"
echo "   • Mengubah bahasa panel"
